...
## Dati operativi
- [ ] **Fasce orarie** di pranzo e cena — il giorno di chiusura (martedì) è già verificato dalla bio Instagram.
...
- [ ] **Coordinate / mappa** (per schema e mappa incorporata).
...
## Menu
- [ ] Piatti, descrizioni, prezzi, categorie dal **menu reale** (oggi su servizio esterno).
...
- [ ] Calendario reale: date, orari, prezzi, posti, modalità di prenotazione. Indizio: su Instagram compare una locandina "appuntamenti del weekend" (vedi `docs/RESEARCH.md`, §4).
